...
Equipment_Width = 115.6; //[75.0:0.1:160.0]
//Depth of the equipment to house 
Equipment_Depth = 111.6; //[25.0:0.1:172.0]
//Height of the equipment to house 
Equipment_Height = 51.7; // [24.0:0.1:70.0]


//Front to back holes for cables.
Front_Cable_Holes = true; // [true:Show front wire holes, false:Hide front wire holes]
...
module switch_mount(Equipment_Width, Equipment_Height, Equipment_Depth) {
    ...
    // Male tongues added to the centre part
